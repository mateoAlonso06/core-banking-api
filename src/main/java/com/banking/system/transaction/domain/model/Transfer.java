...
public class Transfer {
     ...
     * @param debitTransactionId   identifier of the TRANSFER_OUT transaction reconstituted from persistence
     * @param creditTransactionId  identifier of the TRANSFER_IN transaction reconstituted from persistence
     * @param amount               {@link Money} value object reconstituted from the persisted transfer amount
     * @param description          {@link Description} value object reconstituted from the persisted description
     * @param feeAmount            {@link Money} value object reconstituted from the persisted fee amount (may be {@code null})
     * @param feeTransactionId     identifier of the fee transaction reconstituted from persistence (may be {@code null})
     * @param idempotencyKey       {@link IdempotencyKey} value object reconstituted from the persisted idempotency key
     ...
     */
    public static Transfer reconstitue(
            UUID id,
            UUID sourceAccountId,
            UUID destinationAccountId,
            UUID debitTransactionId,
